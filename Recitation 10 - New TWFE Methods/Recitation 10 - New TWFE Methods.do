...
rename _Texp_5  pre2
gen pre1 = 0
rename _Texp_7  post0
rename _Texp_8  post1
rename _Texp_9  post2
rename _Texp_10  post3
rename _Texp_11  post4
rename _Texp_12  post5
rename _Texp_13  post6
rename _Texp_14  post7
rename _Texp_15  post8
rename _Texp_16  pos9
rename _Texp_17  post10
rename _Texp_18  post11
rename _Texp_19  post12

gen no_treat = 1
replace no_treat = 0 if treated == 1

rename post treat_post

stackedev  asmrs pre* post* , cohort(_nfd) time(year)  never_treat(no_treat) unit_fe(stfips) clust_unit(stfips) covariates( pcinc asmrh cases)

event_plot, default_look graph_opt(xtitle("Periods since the event") ytitle("Average effect") xlabel(-6(1)12) ///
		title("stackedev")) stub_lag(post#) stub_lead(pre#)  together 
